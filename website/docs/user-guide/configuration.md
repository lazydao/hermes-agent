...
delegation:
  ...
  #     provider:
  #       sort: throughput
  continuation_reserve_iterations: 0        # Parent iterations retained for async completion on shared request-budget frontends (currently the messaging gateway). CLI/TUI use fresh completion budgets. 0 disables the reserve.
